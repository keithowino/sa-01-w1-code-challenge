...
function n_s_s_f_ratings(gross){
  /*
  Here my understanding was that NSSF = 6% of the gross salary, i am not sure whether this was the right approach, i wasn't able to understand the logic behind the tier table at this link ~ https://www.aren.co.ke/payroll/taxrates.htm you provided us.
  */
  return (gross * 0.06);
};
